...
class CreateScalingConfigurationRequest(AbstractModel):
    ...
    def __init__(self):
        """
        :param scalingConfigurationName: 用户设定的启动配置名称。
        :type scalingConfigurationName: string
        :param imageId: 镜像ID。
        :type imageId: String
        :param cpu: CPU核数，各个地域可选的CPU核数不一样。
        :type cpu: Int
        :param mem: 内存大小，单位为GB，各个地域可选的内存大小不一样。
        :type mem: Int
        :param storageType: 数据盘类型。有三种取值：若为1，表示本地盘；若为2，表示云硬盘；若为3，表示本地SSD；若为5，表示云SSD。
        :type storageType: Int
        :param storageSize: 数据盘大小，单位为GB，步长为10GB。若为本地盘，可选范围在0-500G；若为云硬盘，可选范围在0-4000G。
        :type storageSize: Int
        :param bandwidthType: 带宽的类型。只有两种取值：若为PayByHour，表示按带宽使用时长计费；若为PayByTraffic，表示按流量计费。
        :type imageId: String
        """
    ...
    def _deserialize(self, params):
        ...
        if params.get("imageId") is not None:
            self.imageId = imageId()
            self.imageId._deserialize(params.get("imageId"))
...
class CreateScalingConfigurationResponse(AbstractModel):
    """CreateScalingConfiguration返回参数结构体
...
class HostItem(AbstractModel):
    ...
    def __init__(self):
        """
        :param imageId: cdh实例所在的位置。通过该参数可以指定实例所属可用区，所属项目等属性。
        :type imageId: :class:`tencentcloud.cvm.v20170312.models.imageId`
...
class InquiryPriceRunInstancesRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :type InstanceChargePrepaid: :class:`tencentcloud.cvm.v20170312.models.InstanceChargePrepaid`
        :param imageId: 实例所在的位置。通过该参数可以指定实例所属可用区，所属项目等属性。
        :type imageId: :class:`tencentcloud.cvm.v20170312.models.imageId`
...
class RunInstancesRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :param InstanceChargePrepaid: 预付费模式，即包年包月相关参数设置。通过该参数可以指定包年包月实例的购买时长、是否设置自动续费等属性。若指定实例的付费模式为预付费则该参数必传。
        :type InstanceChargePrepaid: :class:`tencentcloud.cvm.v20170312.models.InstanceChargePrepaid`
        :param imageId: 实例所在的位置。通过该参数可以指定实例所属可用区，所属项目，专用宿主机（对于独享母机付费模式的子机创建）等属性。
        :type imageId: :class:`tencentcloud.cvm.v20170312.models.imageId`
